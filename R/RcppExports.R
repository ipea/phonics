...
#' @export
caixa <- function(word, maxCodeLen = 20L) {
    .Call('_phonics_caixa', PACKAGE = 'phonics', word, maxCodeLen)
}
...
#' @importFrom Rcpp evalCpp
#' @export
metaphone <- function(word, maxCodeLen = 10L, language = "us") {
    .Call('_phonics_metaphone', PACKAGE = 'phonics', word, maxCodeLen, language)
}
